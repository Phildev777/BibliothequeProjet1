...
function toggleText () {
    ...
    puntos1.classList.toggle('hiddennn1');
    
    if (hidenText1.classList.contains('showMas1')){
        readMore1.innerHTML = 'Lire -'; 
     } 
     else {readMore1.innerHTML = 'Lire +'}
...
function toggleText2 () {
    ...
    puntos2.classList.toggle('hiddennn2');

    if (hidenText1.classList.contains('showMas2')){
        readMore2.innerHTML = 'Lire -'; 
     } 
     else {readMore2.innerHTML = 'Lire +'}
}
...
function toggleText3 () {
    ...
    puntos3.classList.toggle('hiddennn3');

    if (hidenText3.classList.contains('showMas3')){
        readMore3.innerHTML = 'Lire -'; 
     } 
     else {readMore3.innerHTML = 'Lire +'}
}
